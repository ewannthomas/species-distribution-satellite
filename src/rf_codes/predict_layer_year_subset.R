...
model_path <- paste0(path_root,"year_subset_model.RData")


pred_tiff_path = "./data/prediction_tiff/pred_stack.tif"

specie_predicted_tiff_path = paste0("./data/species_predicted_tiffs/year_subset/", target_specie, "_", control_specie,".tif")
