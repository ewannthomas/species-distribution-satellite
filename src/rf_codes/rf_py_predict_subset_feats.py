...
model_path = data_folder.joinpath("all_species_subset_feats.bin")
input_raster_path = dir_path.joinpath("data/prediction_tiff/pred_stack_feat_subset.tif")
predicted_raster_path = tiff_folder.joinpath("all_species_py_subset.tif")
...
# #     print('Width:', feat_rast_input.width)pred_stack.tif
